...
public class HabitLog {
    ...
    /**
     * Written by the catch-up for a day that rolled past unanswered, rather
     * than answered by the user. Only these may be superseded by a check-in
     * that was queued offline and arrives late.
     */
